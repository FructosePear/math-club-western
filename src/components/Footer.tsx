// this code isn't used right now because it has no functionality
...
const Footer = () => {
  ...
  return (
    ...
    //                 Want to sign up for our events?
    //               </h2>

    //               <p className="mt-4 text-gray-500">
    //                 Join our mailing list, where you can receive periodic
    //                 updates, news, and opportunities to be ever more involved
    //                 with math!
    //               </p>
    //             </div>
    //           </div>
    ...
    //                     <a
    //                       href="#"
    //                       className="block w-full text-gray-700 transition hover:opacity-75"
    //                     >
    //                       Placeholder
    //                     </a>
    //                   </li>
    ...
    //             <li>
    //               <a
    //                 href="https://discord.gg/HCg9pX2ZJx"
    //                 rel="noreferrer"
    //                 target="_blank"
    //                 className="text-gray-700 transition hover:opacity-75"
    //               >
    ...
    //           &copy; 2025. Students United by Mathematics. All rights reserved.
    //         </p>
